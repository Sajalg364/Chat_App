		...
		<div className="w-full min-h-32  shadow-gray-950 shadow-inner flex flex-col justify-between items-start px-4 py-8 bg-slate-800 text-white">
			...
			<div className="flex items-center justify-start w-full p-4 flex-wrap">
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>Sajal Mahajan</span>
					<span>Mainpuri, UP</span>
					<span>Pincode - 205001</span>
					<span>
						<Link
							to={"mailto:contact.sajalg903090@gmail.com"}
							target="_blank"
							className="hover:text-blue-600 hover:underline"
						>
							contact.sajalg903090@gmail.com
						</Link>
					</span>
				</div>
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
				...
				<div className="flex flex-col min-w-[280px] w-[33%] my-3">
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://www.linkedin.com/in/sajal-mahajan-a58b9524a/"
							target="_blank"
							rel="noreferrer"
						>
							LinkedIn
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://leetcode.com/u/sajalg364/"
							target="_blank"
							rel="noreferrer"
						>
							Github
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="https://instagram.com/sajal_gupta2/"
							target="_blank"
							rel="noreferrer"
						>
							Instagram
					...
					<span>
						<a
							className="hover:text-blue-600 hover:underline"
							href="mailto:contact.sajalg903090@gmail.com"
							target="_blank"
							rel="noreferrer"
						>
							E-Mail
